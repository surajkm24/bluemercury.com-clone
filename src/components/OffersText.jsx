import {Slide, Box, Text,ScaleFade} from '@chakra-ui/react';
...
export const OffersText = () => {
    ...
    return <>
        <Box bg='#d7ebf2' py='7px' mt='10px' >
            <ScaleFade initialScale={0.4} in={slide.first} direction='right' style={{display:slide.first?'block':"none"}}>
                <Text fontSize='14px' letterSpacing='1px' color='#12284c' fontWeight='500' width='fit-content' m='auto'>Free Gifts With Purchase. Browse Now &gt;</Text>
            </ScaleFade>
            <ScaleFade initialScale={0.4} in={slide.second} direction='right' style={{display:slide.second?'block':"none"}}>
                <Text fontSize='14px' letterSpacing='1px' color='#12284c' fontWeight='500' width='fit-content' m='auto'>Free Samples With All Orders</Text>
            </ScaleFade>
            <ScaleFade initialScale={0.4} in={slide.third} direction='right' style={{display:slide.third?'block':"none"}}>
                <Text fontSize='14px' letterSpacing='1px' color='#12284c' fontWeight='500' width='fit-content' m='auto'>Free Shipping for BlueRewards Members</Text>
            </ScaleFade>
        </Box>
    </>
}