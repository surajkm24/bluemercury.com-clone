...
export const BestSellers = () => {
    ...
    <Heading cursor='pointer' textAlign='center' fontSize='28px' color='#12284C' fontWeight={200} letterSpacing='2px' fontFamily='Montserrat Light,sans-serif'>BEST SELLERS</Heading>
    <Show above='1024px'>
